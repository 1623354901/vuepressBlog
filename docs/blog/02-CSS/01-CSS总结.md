...
**1. 小黄色块**在图片上移动，**吸引用户的眼球**。
 ...
 <img src="./media/01_定位示例1.gif" />


**2. 当我们滚动窗口的时候，盒子是固定屏幕某个位置的**

<img src="./media/ding.png" />
...
2. **父元素没有定位**，则以**浏览器**为准定位（Document 文档）。
   ...
   <img src="./media/05_绝对定位_父级无定位.png" width="700" />

3. **父元素要有定位**

   - 将元素依据最近的已经定位（绝对、固定或相对定位）的父元素（祖先）进行定位。

<img src="./media/06_绝对定位_父级有定位.png" width="700" />
